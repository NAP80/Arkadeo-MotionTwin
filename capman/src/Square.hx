...
// Case de la grille : murs, pièce, distances de pathfinding, et FX liés (burstWall quand un mur saute, fxTwinkle pour les étincelles).
class Square {
	...
	// FX - éclats de mur (monstre Block qui défonce un mur).
	...
	// Étincelle (spawn / sillage starDust) : LightTriangle teinté, en blendMode ADD.
	public function fxTwinkle() {
		...
		untyped p.root.tint = color;
		untyped p.root.blendMode = pixi.core.Pixi.BlendModes.ADD;
		return p;
	}
}
