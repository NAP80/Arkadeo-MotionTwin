...
// onDie dépend du mode : en Progression, ordre d'activation + porte de fin d'origine ;
// en Défi Coffres, pas d'ordre ni de porte, c'est le mode qui gère score et respawn.
class Lock extends en.Mob {
	...
	override function onDie() {
		...
		// Défi Coffres : le mode gère score et respawn (toujours 2 coffres, à l'infini).
